...
from voice    import VoiceManager           # TTS + STT unifiés
...
# ══════════════════════════════════════════════════════════════════════════════
# MODE TEXTE — boucle terminal classique (freev4 inchangé)
# ══════════════════════════════════════════════════════════════════════════════
def run_text_mode():
    """Lance Freev en mode texte interactif (comportement original de freev4)."""
    freev = Freev()
    freev.run()
    ...
    try:
        while True:
            try:
                ...
                stop_anim.set()   # stopper l'animation si erreur avant set()
                error_count += 1
